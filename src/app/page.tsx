...
const t: Record<Lang, {
  ...
  zh: {
    ...
    products: [
      ...
      ['08','充电网络','基础设施','服务于 Hybrid 全线车队的固定及移动充电站。'],
    ],
    divisions: [
      ['01','Hybrid 航空航天','电动喷气机生产、航天港、卫星星座。','北纬64.386°'],
      ['02','Hybrid 机器人','机械臂、仿生假肢、月球车、增材制造。','研发中心'],
      ['03','Hybrid 交通','电动列车、公交车、自动驾驶货运牵引车。','交通运输'],
      ['04','Hybrid 充电','固定及移动充电站网络。','基础设施'],
