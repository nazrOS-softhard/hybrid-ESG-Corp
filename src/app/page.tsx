...
const t: Record<Lang, {
  ...
  ru: {
    ...
    nav: ['Основа', 'Подразделения', 'Миссии', 'В Пути'],
    vputi_btn: 'В Пути →',
    eyebrow: 'Конгломерат Гибрид · Осн. 2024',
    h1a: 'От электроджетов и лунных роверов', h1b: ' до освоения внеземных ресурсов',
    sub: 'Углеродно-нейтральная робототизированная техника ',
    cta1: 'Миссии', cta2: 'Гибрид В Пути →',
